<?php
$page_title = 'Zanzibar Beach Holidays | Safari & Beach Combo';
$page_description = 'Discover Zanzibar pristine beaches, historic Stone Town, and crystal-clear waters. Add a Zanzibar beach extension to your Tanzania safari for the ultimate holiday.';
...
<section class="py-20 bg-sand">
  <div class="container-md">
    <div class="section-heading reveal">
      ...
      <h2 class="section-title">Safari & Zanzibar Combo</h2>
      <p class="section-desc">Combine Tanzania's iconic wildlife with Zanzibar's tropical paradise in one incredible trip.</p>
    </div>
    <a href="mar-april-2026-safari-zanzibar.php" class="featured-package-card reveal" style="display:grid;grid-template-columns:1fr 1fr;gap:0;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.10);text-decoration:none;color:inherit;transition:transform 0.3s,box-shadow 0.3s;">
      ...
      <div style="padding:2.5rem;display:flex;flex-direction:column;justify-content:center;">
        ...
        <p style="color:#666;line-height:1.7;margin-bottom:1.5rem;">5-day safari through Tarangire, Serengeti and Ngorongoro plus 3 nights all-inclusive Zanzibar beach resort. Includes domestic flight and Stone Town tour.</p>
