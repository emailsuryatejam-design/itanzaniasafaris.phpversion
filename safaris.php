<?php
$page_title = 'Tanzania Safari Packages 2026 | From $1,476pp';
$page_description = 'Book 2026 Tanzania safari packages. 5N/6D Tarangire, Serengeti & Ngorongoro from $1,476pp or 7N/8D Safari + Zanzibar beach from $2,417pp. Budget to Premium options.';
...
<section class="py-20 bg-white">
  <div class="container-md">
    <div class="section-heading reveal">
      <span class="section-subtitle">Featured Packages</span>
      <h2 class="section-title">2026 Safari Deals</h2>
      <p class="section-desc">Limited-time safari packages at special rates. Book early to secure your spot.</p>
    </div>
    <a href="feb-march-2026-safari.php" class="featured-package-card reveal" style="display:grid;grid-template-columns:1fr 1fr;gap:0;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.10);text-decoration:none;color:inherit;transition:transform 0.3s,box-shadow 0.3s;margin-bottom:2.5rem;">
      ...
      <div style="padding:2.5rem;display:flex;flex-direction:column;justify-content:center;">
        ...
        <p style="color:#666;line-height:1.7;margin-bottom:1.5rem;">Experience the best of Northern Tanzania's wildlife circuit. Witness the Great Migration, explore the Ngorongoro Crater, and encounter elephants in Tarangire &mdash; with 4 accommodation options from Budget to Premium.</p>
    ...
    <a href="mar-april-2026-safari-zanzibar.php" class="featured-package-card reveal" style="display:grid;grid-template-columns:1fr 1fr;gap:0;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.10);text-decoration:none;color:inherit;transition:transform 0.3s,box-shadow 0.3s;">
      <div style="position:relative;overflow:hidden;min-height:300px;">
      ...
      <div style="padding:2.5rem;display:flex;flex-direction:column;justify-content:center;">
        ...
        <h3 style="font-size:1.6rem;margin:0.5rem 0;color:#1a1a1a;">Safari & Zanzibar Beach Holiday</h3>
        <p style="color:#666;line-height:1.7;margin-bottom:1.5rem;">The ultimate Tanzania experience combining a 5-day safari through Tarangire, Serengeti and Ngorongoro with a relaxing 3-night all-inclusive Zanzibar beach holiday. Includes domestic flight and Stone Town tour.</p>
        <div style="display:flex;align-items:center;gap:1.5rem;flex-wrap:wrap;">
          <span style="font-size:1.3rem;font-weight:700;color:var(--primary);">From $2,417 <span style="font-size:0.85rem;font-weight:400;color:#999;">per person</span></span>
          <span style="display:inline-flex;align-items:center;gap:6px;color:var(--secondary);font-weight:600;font-size:0.95rem;">View Itinerary <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg></span>
        </div>
      </div>
    </a>
